...
//!
//! 输出: gto_tr_t2\candidate\tr_candidate_v2.exe + 自解析验证打印。
//! v2: 基于 D_b1 新观测面 (T3-4, BTIT 修复后 TEXT 98 页), EP=0x105a58 真 OEP 交接链。
...
const COMPONENTS: &str = r"D:\MidaVault\lab\evidence\gto_tr_t2\components_v2";
const PROVENANCE: &str = r"D:\MidaVault\lab\evidence\gto_tr_t2\provenance_v2.json";
const OUT: &str = r"D:\MidaVault\lab\evidence\gto_tr_t2\candidate\tr_candidate_v2.exe";
