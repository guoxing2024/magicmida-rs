...
工单顺序（**串行派发，同一时间只派一单**——D-014；worker 在飞期间禁止派新单——D-026）：**TASK-016 审计 = 条件通过（D-031），补正轮 TASK-016R1 在飞（D-030 范围内零实弹不耗格）→ R1 验收后 T016 整单入栈，再等老板裁定（T0.5 续跑 / TASK-007 / clippy 基线门修复授权 D-031 F3）**。TASK-005/009/010/011/012/013/006R5/014/015 已完成；TASK-006R/R2/R3 终态路径 C、R4 终态 STOP、R5 终态路径 A、T014 终态路径 A'、T015 终态路径 B1'（实弹累计 **9/4**，记 D-022/D-027/D-029）。
