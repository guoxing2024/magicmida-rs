...
工单顺序（**串行派发，同一时间只派一单**——D-014；worker 在飞期间禁止派新单——D-026）：**TASK-016（已授权 D-030：阶段收尾——硬编码审计清除 + preflight 能力预检 + runbook + 全仓回归快照，纯离线零实弹）→ 之后等老板裁定（T0.5 续跑 / TASK-007）**。TASK-005/009/010/011/012/013/006R5/014/015 已完成；TASK-006R/R2/R3 终态路径 C、R4 终态 STOP、R5 终态路径 A、T014 终态路径 A'、T015 终态路径 B1'（实弹累计 **9/4**，记 D-022/D-027/D-029）。
