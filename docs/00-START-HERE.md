...
工单顺序（**串行派发，同一时间只派一单**——D-014；worker 在飞期间禁止派新单——D-026）：**TASK-021（T0.5 三态重跑·收官之战：B1' 宿主 a852880a + 清洗后候选 core 094f5401 + 调试端口泵 + 基址硬门，实弹 1 格 12/4 → 13/4，D-042）在飞。**前置链全部就绪：T017（P-11 垫零→工具性阻塞）→ T018（C-8 原版 core 附加即死，P-10 失误）→ T019（C-5 候选陈旧指针，归因被法证纠正）→ T020+R1（清洗 8/8 验收）。`.winlice` 13 残留风险注记入票。其余暂缓（TASK-007 / clippy 基线门 D-031 F3 / §九 GTO-UI / 推送 34 提交）。TASK-005/009/010/011/012/013/006R5/014/015/016(+R1)/017/018/019/020(+R1) 已完成。
