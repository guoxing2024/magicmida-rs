...
工单顺序（**串行派发，同一时间只派一单**——D-014）：**TASK-014（已起草，待授权：`crates/pe`+`themida` 改动 + 一格实弹 7/4→8/4——IAT 启动路径 192 站点重建，路径 B 硬前置）→ T0.5 续跑 → TASK-007**。TASK-005/009/010/011/012/013/006R5 已完成；TASK-006R/R2/R3 终态路径 C、R4 终态 STOP、R5 终态路径 A（实弹累计 **7/4**，记 D-022）。
