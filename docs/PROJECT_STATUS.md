...
下一件最要紧的事是 **TASK-006R3**（已授权，可直接派）：缺陷 A（C-4 / TASK-009）的路径 A/B 实弹替换验证。老板 2026-08-30 三条裁定已落账：追认 TASK-006R2 那一格（D-015，XC-XXI-B 4/4 成立）、扩额批 TASK-006R3 一格（D-016，→ 5/4）、授权迁移工作区大文件证据（D-017）。机器已重启，总指挥亲验 BootTime = `2026-08-30 00:54:51`。**离线侧无待办工单。**
...
① **TASK-006R3**（已授权，已换 boot）验缺陷 A 路径 A/B → ② T0.5 续跑 → ③ TASK-007。
