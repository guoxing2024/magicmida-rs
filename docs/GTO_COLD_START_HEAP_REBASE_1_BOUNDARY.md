...
| H4-A SMR (ViaStableBinding stub exec) | TECHNICAL PASS + LIVE EVIDENCE (3 ASLR layouts, exit 0, unresolved_required=0/0/0); **FORMAL SIGN-OFF GRANTED 2026-08-22 (delegated authority, all 6 items PASS)** | docs/GTO_H4_ABC_FORMAL_SIGNOFF_20260821.md; docs/GTO_COLD_START_HEAP_REBASE_1_H4A_SMR_DESIGN.md, docs/GTO_COLD_START_HEAP_REBASE_1_H4A_REPORT.md; evidence H4A_smr/ + H4A_smr/layout_B/ |
...
| H5 acceptance | **BLOCKED_AT_LOADER_SMOKE → LIVE REOPENED** (loader smoke 9/9 exit 0xC0000005 historical; root cause PENDING — r9 encrypted-region boundary; **GTO-H5-LIVE-AUTHORIZATION-2 GRANTED 2026-08-22: ledger `GTO-H5-LIVE-2` cap=2 used=0; Round 1 = re-baseline + R2 entropy measurement + loader smoke N≥3; Round 2 conditional on Round-1 data + separate design note**) | docs/GTO_H5_LIVE_AUTHORIZATION_2_20260821.md (terms); docs/GTO_H5_LOADER_WALL_ROOT_CAUSE.md, docs/GTO_H5_STARTUP_ORDER_ATTRIBUTION_REPORT.md, docs/GTO_H5_R9_ORIGIN_CAUSAL_PROOF_REPORT.md; evidence H5_acceptance_1/, H5_crash_attribution_A/, H5_resolver_causal_proof/, H5_r9_origin_proof/ |
