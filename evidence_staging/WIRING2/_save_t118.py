...
with open(r"D:\Claude project\magicmida-rs\evidence_staging\WIRING2\walker_dispatch_test_raw.txt", "w", encoding="utf-8") as f:
    f.write("RC=" + str(r2.returncode) + "\n" + r2.stdout.decode("utf-8", errors="replace") + "\n---STDERR---\n" + r2.stderr.decode("utf-8", errors="replace"))
